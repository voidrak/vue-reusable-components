...
const props = defineProps({
  ...
  variant: { 
    type: String, 
    default: 'primary',
    validator: v => ['primary', 'secondary', 'success', 'danger', 'warning', 'outline', 'ghost', 'link'].includes(v),
  },
  type: {
    type: String,
    default: 'button',
...
const variantClasses = {
  ...
  secondary: 'bg-primary-100 text-primary-900 hover:bg-primary-200 focus:ring-primary-500 disabled:bg-gray-100 disabled:text-gray-400',
  ...
  outline: 'bg-transparent border border-primary-600 text-primary-600 hover:bg-primary-50 focus:ring-primary-500 disabled:border-gray-300 disabled:text-gray-400',
  ghost: 'bg-transparent text-primary-600 hover:bg-primary-50 focus:ring-primary-500 disabled:text-gray-400',
